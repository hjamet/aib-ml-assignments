...
def render_regression_page():
    ...
    if selected_models:
        ...
        render_model_info_cards(selected_models, "Regression")
    ...
    if selected_metrics:
        ...
        render_metric_info_cards(selected_metrics, "Regression")
    ...
    if selected_models:
        ...
        toc_subsubheader(f"📈 Regression Analysis - {selected_model_name}")
